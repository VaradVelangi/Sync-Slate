    ...
    return (
        <div className="flex w-full max-w-[500px] flex-col items-center justify-center gap-4 p-4 sm:w-[500px] sm:p-8">
            <form onSubmit={joinRoom} className="flex w-full flex-col gap-4">
                ...
                <button
                    type="submit"
                    className="mt-2 w-full rounded-md border-black bg-pink-700 hover:bg-red-800 text-white px-8 py-3 text-lg font-semibold "
                >
                    Join
                </button>
            </form>
            <button
                className="cursor-pointer px-8 py-3 border-black select-none rounded-md bg-pink-700"
